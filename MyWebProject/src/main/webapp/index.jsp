                ...
                <div class="product-slider">
                    <div class="item">
                        <div class="product">
                            ...
                            <a href="/viewDetails" class="invisible">
                                <img src="img/product1.jpg" alt="" class="img-responsive">
                            </a>
                            <div class="text">
                                <h3><a href="/viewDetails">Fur coat with very but very very long name</a></h3>
                    ...
                    <div class="item">
                        <div class="product">
                            ...
                            <div class="text">
                                <h3><a href="/viewDetails">White Blouse Armani</a></h3>
                                <p class="price">
                                    <del>$280</del>
                                    $143.00
                                </p>
                    ...
                    <div class="item">
                        <div class="product">
                            ...
                            <div class="text">
                                <h3><a href="/viewDetails">Black Blouse Versace</a></h3>
                                <p class="price">$143.00</p>
                            </div>
                            <!-- /.text -->
                        </div>
                    ...
                    <div class="item">
                        <div class="product">
                            ...
                            <div class="text">
                                <h3><a href="/viewDetails">White Blouse Versace</a></h3>
                                <p class="price">$143.00</p>
                            </div>
                            <!-- /.text -->
                    ...
                    <div class="item">
                        <div class="product">
                            ...
                            <div class="text">
                                <h3><a href="/viewDetails">Fur coat</a></h3>
                                <p class="price">$143.00</p>
                            </div>
                            <!-- /.text -->
