...
/**
 * Фильтр проверки авторизации пользователя.
 * При переходе на соответствующую страницу происходит проверка на ниличие атрибута "userType" HttpSession,
 * в случае его отсутствия происходит перенаправление на страницу авторизации.
 */

@Log4j
@WebFilter(urlPatterns = "/buy-product")
