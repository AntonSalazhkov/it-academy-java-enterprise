...
/**
 * Сервлет обработки совершаемой покупки продукта.
 * По результатам обработки перенаправляет на страницу успешно или не успешно совершенной покупки.
 */
...
public class BuyProductController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (service.buyProduct(req, product, productQuantity)) {
