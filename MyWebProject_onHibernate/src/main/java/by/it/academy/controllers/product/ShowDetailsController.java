...
/**
 * Сервлет обработки отображения деталей продукта.
 * Передаст выбранный по "id" продукт через атрибут HttpServletRequest для его отображения на странице.
 * По результатам обработки перенаправит на WEB-страницу деталей продукта.
 */
