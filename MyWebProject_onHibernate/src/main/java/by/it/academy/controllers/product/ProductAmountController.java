...
/**
 * Сервлет обработки стоимости совершаемой покупки продукта.
 * По результатам обработки перенаправляет на страницу корзины покупок с задаваемым для HttpServletRequest атрибутом
 * стоимости и количества покупок, которые отобразятся соответствующими значениями на WEB-странице.
 */
