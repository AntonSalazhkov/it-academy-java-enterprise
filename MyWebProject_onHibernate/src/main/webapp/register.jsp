    ...
    <div class="container">
        ...
        <div class="navbar-buttons">
            ...
            <div class="navbar-collapse collapse right" id="basket-overview">
                <a href="#" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span
        ...
        <div class="container">
                ...
                <div class="box">
                    ...
                    <form action="/registration" method="POST">
                        ...
                        <div class="text-center">
                            <p style="color: red"> ${incorrectRegistration} </p>
                            <button type="submit" class="btn btn-primary"><i class="fa fa-user-md"></i> Register
                            </button>
                        </div>
            ...
            <div class="col-md-6">
                <div class="box">
                    ...
                    <p class="text-muted">You can log in with your username and password by filling out the form
                        below.</p>
                    ...
                    <form action="/authorization" method="POST">
                        ...
                        <div class="text-center">
                            <p style="color: red"> ${incorrectAuthorization} </p>
