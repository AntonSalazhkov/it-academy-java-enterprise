 ...
 * <p>
 * Метод addProduct прослушивает адресс /products/admin/new-product, в случае корректности введеных данных, добавит новый продукт в базу дынных.
 ...
 * <p>
 * Метод updateProduct прослушивает адресс /products/admin, принимает поступающий "id" продукта в виде UUID и новые значения продукта,
 ...
 * <p>
 * Метод updateQuantityProduct прослушивает адресс /products/admin/no-product, принимает поступающий "id" продукта в виде UUID,
...
public class ProductController {
    ...
    @GetMapping(consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public Product showProductById(@RequestBody @Validated ProductRequest idProductRequest) {
    ...
    public Product createProduct(@RequestBody @Validated CreateProductRequest addProductRequest) {
    ...
    @RequestMapping("/admin/no-product")
    @PutMapping(consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public boolean updateQuantityProduct(@RequestBody @Validated ProductRequest idProductRequest) {
        return productService.clearQuantityProduct(idProductRequest);
    }
}
